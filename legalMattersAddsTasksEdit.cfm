<cfif isDefined("FORM.idTask")>
	...
	<script>
		...
		ColdFusion.Window.destroy('legalMatterTaskEdit#FORM.idTask#',true);
	</script>
    </cfoutput>
</cfif>
	...
	<fieldset>
		...
		<ul class="col2">
			<li class="inputDateTime"><label for="taskStart">Start</label>
				<cfinput size="10" name="taskStart" type="datefield" value="#dateFormat(thisTask.taskStart, 'mm/dd/yyyy')#" required="yes"  mask="mm/dd/yyyy"  validate="date" message="Start date should be 'mm/dd/yyyy'">
			</li>
			<li class="inputTime">
			...
			<li class="inputDateTime"><label for="taskEnd">End</label>
				<cfinput size="10" name="taskEnd" type="datefield" value="#dateFormat(thisTask.taskEnd, 'mm/dd/yyyy')#" bind="{taskStart}" mask="mm/dd/yyyy"  validate="date" message="End date should be 'mm/dd/yyyy'" >
			</li>
			<li class="inputTime">
