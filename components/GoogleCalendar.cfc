...
<cffunction name="addEvent" access="public" returnType="any" output="false" hint="Adds an event. Returns Success or another message.">
  ...
  <cfargument name="resultType" type="string" required="false" hint="fileContent, fullResponse, successCode" default="fullResponse">
  ...
  <cfelse>
    ...
    <cfset arguments.start = dateFormat(arguments.start, "yyyy-mm-dd") & "T" & timeFormat(arguments.start, "HH:mm:ss") & "Z">
    <cfset arguments.end = dateFormat(arguments.end, "yyyy-mm-dd") & "T" & timeFormat(arguments.end, "HH:mm:ss") & "Z">
  ...
  <cftry>
    ...
    <cfelse>
      ...
      <cfif structKeyExists(arguments, "where")>
          ...
          <gd:when startTime='#arguments.start#'
    	endTime='#arguments.end#'></gd:when>
    </cfif>
      </entry>
    </cfoutput>
    </cfsavecontent>
  ...
  <cfif result.responseheader.status_code is "201">
	...
	<cfif resultType eq 'fileContent'>
      <cfreturn result.fileContent>
    
	<cfelseIf resultType eq 'fullResponse'>
      <cfreturn result>
    ...
    <cffunction name="addCalendar" access="public" returnType="string" output="false" hint="Adds a calendar. Returns Success or another message.">
        <cfargument name="title" type="string" required="true">
        <cfargument name="description" type="string" required="true">
        <cfargument name="color" type="string" required="false" default="##29527A" hint="the hex code for a color">
        ...
        <cfsavecontent variable="myxml">
            ...
            <gCal:timezone value='UTC-05:00'></gCal:timezone>
