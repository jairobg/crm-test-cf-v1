...
<cfif isDefined("FORM.name")>
	...
	<cfif addHolderMessage EQ "">
		<script>
			...
			ColdFusion.Window.destroy('addCollector',true);
		</script>
	</cfif>
</cfif>
...
<cfform name="collectorsAddForm1">

<cfinput type="hidden" name="type" value="COLLECTOR">
...
--->
		...
		<li><label for="notes">Notes</label><cftextarea name="notes" rows="4" cols="25"></cftextarea></li>
	</ul>
</fieldset>
